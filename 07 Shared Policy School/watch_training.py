"""Delayed finish-check watcher for V7 shared-policy schooling runs."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Watch a V7 schooling training run and auto-evaluate when it finishes.")
    parser.add_argument("--pid-file", type=str, default="./baseline_v7_school.pid")
    parser.add_argument("--checkpoint-root", type=str, default="./rllib_checkpoints_baseline_v7_school")
    parser.add_argument("--log-path", type=str, default="./baseline_v7_school.out.log")
    parser.add_argument(
